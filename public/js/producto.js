...
function formatearNumero(input) {
    ...
    if(numero.length === 0){
        p.classList.contains('bg-mc') ? p.classList.remove('bg-mc') : '';
        p.classList.contains('bg-vi') ? p.classList.remove('bg-vi') : '';
        p.classList.contains('bg-am') ? p.classList.remove('bg-am') : '';
    }
